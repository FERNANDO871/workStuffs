        ...
        <main class="shop-main_content">
            <div class="container-fluid">
              ...
              <!--       <?php /* foreach($ListaProductos as $row){ */?> -->
                    ...
                    <div class="container">
                      <div class="shop-product-wrap grid gridview row-4"> 
                            <div class="col-4">
                                    ...
                                    <div class="single-product">      
                                        ...
                                        <div class="product-img">
                                            <a href="single-product.html">
                                                ...
                                                <img class="secondary-img" ssrc="data:imag/jpg;base64,<?php echo base64_encode($row['Imagen']);?>"/>
                                            </a>
                                        ...
                                        <div class="product-content">
                                            <div class="product-desc_info">
                                                ...
                                                <div class="price-box">
                                                    <span class="new-price ms-0">$
                                                        <?php echo $row['PrecioProd'] ?></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="list-product_item">
                                    <div class="single-product">
                                        <div class="product-img">
                                            <a href="single-product.html">
                                                <img class="primary-img" src="data:image/jpg;base64,<?php echo base64_encode($row['Imagen']);?>"/>
                                                <img class="secondary-img"src="data:image/jpg;base64,<?php echo base64_encode($row['Imagen']);?>"/>
                                            </a>
                                            <div class="add-actions">
                                                <ul>
                                                    <li class="yena-view-btn" data-bs-toggle="modal" data-bs-target="#exampleModalCenter"><a href="javascript:void(0)" data-bs-toggle="tooltip" data-placement="top" title="Quick View"><i
