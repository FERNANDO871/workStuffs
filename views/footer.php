   <!-- Begin Footer Area -->
      <div class="footer-area border-top">
        ...
        <div class="modal fade modal-wrapper" id="exampleModalCenter">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-body">
                        ...
                        <div class="modal-inner-area product-details_area row" id="productomodal">
         ...
         <div class="modal fade modal-wrapper" id="modalcarrito">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-body">
                        <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                        ...
                        <div class="modal-inner-area product-details_area row" id="">
                ...
                <div class="row">
                    <div class="col-12">
                        <form action="javascript:void(0)">
                            <div class="table-content table-responsive" id="carritomodal">
                            ...
                            <div class="row">
                                <div class="col-md-5 ml-auto">
                                    <div class="cart-page-total">
                                        ...
                                        <a href="javascript:void(0)">Proceed to pay</a>
                                    </div>
                                </div>
                            </div>
                        </form>
