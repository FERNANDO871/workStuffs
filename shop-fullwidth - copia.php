...
<head>
    ...
    <title>Shop Fullwidth || Yena</title>
                                ...
                                <div class="col-lg-6 position-static d-none d-xl-block">
                                    <div class="main-menu_area d-none d-lg-block">
                                        <nav class="main-nav d-flex justify-content-center">
                                            <ul>
                                                <li class="megamenu-holder two-column position-static"><a class="" href="javascript:void(0)">Home <i class="bi bi-chevron-compact-down"></i></a>
                                                    <div class="yena-megamenu_wrap">
                                                        <ul class="yena-megamenu">
                                                            <li>
                                                                <ul>
                                                                    <li><a class="" href="index.html">Home 01</a></li>
                                                ...
                                                <li><a class="" href="javascript:void(0)">Pages <i class="bi bi-chevron-compact-down"></i></a>
                                                ...
                                                <li class="megamenu-holder megamenu-gallery_holder position-static">
                                                    <a href="javascript:void(0)">Collection
                                                        ...
                                                        <ul class="yena-megamenu">
                                                                ...
                                                                <ul>
                                                                    <li>
                                                                        <a href="shop-fullwidth.html">
                                                                            <img src="assets/images/menu/1.jpg" alt="Megamenu's Gallery">
                                                                        </a>
                                                                        <span class="inner-text">Skin care</span>
                                                                    </li>
                                                                    <li>
                                                                        <a href="shop-fullwidth.html">
                                                                            <img src="assets/images/menu/2.jpg" alt="Megamenu's Gallery">
                                                                        </a>
                                                                        <span class="inner-text">Skin care</span>
                                                                    </li>
                                                                </ul>
                                                            ...
                                                            <li class="gallery-wrap">
                                                                <ul>
                                                                    <li>
                                                                        <a href="shop-fullwidth.html">
                                                                            <img src="assets/images/menu/3.jpg" alt="Megamenu's Gallery">
                                                                        </a>
                                                                        <span class="inner-text">Skin care</span>
                                                                    </li>
                                                                    <li>
                                                                        <a href="shop-fullwidth.html">
                                                                            <img src="assets/images/menu/4.jpg" alt="Megamenu's Gallery">
                                                                        </a>
                                                                        <span class="inner-text">Skin care</span>
                                                                    </li>
                                                                </ul>
                                                            ...
                                                            <li class="gallery-wrap">
                                                                <ul>
                                                                    <li>
                                                                        <a href="shop-fullwidth.html">
                                                                            <img src="assets/images/menu/5.jpg" alt="Megamenu's Gallery">
                                                                        </a>
                                                                        <span class="inner-text">Skin care</span>
                                                                    </li>
                                                                    <li>
                                                                        <a href="shop-fullwidth.html">
                                                                            <img src="assets/images/menu/6.jpg" alt="Megamenu's Gallery">
                                                                        </a>
                                                                        <span class="inner-text">Skin care</span>
                                                                    </li>
                                                                </ul>
                                                ...
                                                <li class="megamenu-holder position-static"><a class="active" href="shop-fullwidth.html">Shop <i class="bi bi-chevron-compact-down"></i></a>
                                                    <div class="yena-megamenu_wrap">
            ...
            <div class="offcanvas-minicart_wrapper" id="miniCart">
                <div class="offcanvas-menu-inner">
                        ...
                        <ul class="minicart-list">
                            <li class="minicart-product">
                                ...
                                <div class="product-item_content">
                                    <a class="product-item_title" href="shop-fullwidth.html">InstaBoost Conditioning Color Masque</a>
                                    <span class="product-item_quantity">1 x $20.00</span>
                                </div>
                            </li>
                            <li class="minicart-product">
                                <a class="product-item_remove" href="javascript:void(0)"><i
                                    class="bi bi-file-x"></i></a>
                                <div class="product-item_img">
                                    <img class="img-full" src="assets/images/product/small-size/2.jpg" alt="Yena's Product Image">
                                </div>
                                <div class="product-item_content">
                                    <a class="product-item_title" href="shop-fullwidth.html">L'Oreal Paris Magic Perfecting Base Face</a>
                                    <span class="product-item_quantity">1 x $20.00</span>
                                </div>
                            </li>
                            <li class="minicart-product">
                                <a class="product-item_remove" href="javascript:void(0)"><i
                                    class="bi bi-file-x"></i></a>
                                <div class="product-item_img">
                                    <img class="img-full" src="assets/images/product/small-size/3.jpg" alt="Yena's Product Image">
                                </div>
                                <div class="product-item_content">
                                    <a class="product-item_title" href="shop-fullwidth.html">InstaBoost Conditioning Color Masque</a>
                                    <span class="product-item_quantity">1 x $20.00</span>
                    ...
                    <div class="minicart-btn_area">
                        <a href="cart.php" class="yena-btn yena-btn_fullwidth square-btn">Minicart</a>
                    </div>
                    <div class="minicart-btn_area">
                        <a href="checkout.html" class="yena-btn yena-btn_fullwidth square-btn">Checkout</a>
                    </div>
                </div>
            </div>
        ...
        <div class="breadcrumb-area ">
            <div class="container-fluid h-100">
                <div class="breadcrumb-content h-100">
                    <h2 class="text-capitalize mb-0">Shop Fullwidth</h2>
                    <ul>
                        <li><a href="index.html">Home</a></li>
                        <li class="active">Shop Fullwidth</li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="shop-toolbar">
                            ...
                            <div class="product-selection_wrap">
                                    ...
                                    <nav class="product-selection_nav">
                                        <ul>
                                            <li class="dropdown-holder">
                                                <a href="javascript:void(0)">View <i class="bi bi-chevron-compact-down"></i></a>
                                                <ul class="ps-dropdown product-view-mode">
                                                    <li><a class="grid-5" data-target="gridview-5" href="javascript:void(0)">View 05</a></li>
                                                    <li><a class="grid-4 active" data-target="gridview-4" href="javascript:void(0)">View 04</a></li>
                                                    <li><a class="grid-3" data-target="gridview-3" href="javascript:void(0)">View 03</a></li>
                                                    <li><a class="grid-2" data-target="gridview-2" href="javascript:void(0)">View 02</a></li>
                                                </ul>
                                            </li>
                                            <li class="dropdown-holder">
                                                <a href="javascript:void(0)">Show 12 <i class="bi bi-chevron-compact-down"></i></a>
                                                <ul class="ps-dropdown show-wrap">
                                                    <li><a href="javascript:void(0)">Show 12</a></li>
                                                    <li><a href="javascript:void(0)">Show 15</a></li>
                                                    <li><a href="javascript:void(0)">Show 20</a></li>
                                                </ul>
                                            </li>
                                            <li class="filter-item_wrap">
                                            ...
                                            <li class="dropdown-holder">
                                                <a href="javascript:void(0)">Sort by Default <i class="bi bi-chevron-compact-down"></i></a>
                                                <ul class="ps-dropdown sort-wrap">
                                                    <li><a href="javascript:void(0)">Sort by Default</a></li>
                                                    <li><a href="javascript:void(0)">Sort by Popularity</a></li>
                                                    <li><a href="javascript:void(0)">Sort by Rated</a></li>
                                ...
                                <div class="product-view-mode">
                                    <a class="active grid-4" data-target="gridview-4" data-toggle="tooltip" data-placement="top" title="Grid View">
                                        <i class="lastudioicon-microsoft"></i>
                                    </a>

                                    <a class="list" data-target="listview" data-toggle="tooltip" data-placement="top" title="List View">
                        ...
                        <div class="filter-body">
                            <div class="row">
                                <div class="col-lg-3">
                                    <div class="widgets-area filter-item_area pt-0">
                                        <h2 class="heading text-capitalize font-style_italic mb-0"><span>Filter by Categories</span></h2>
                                        <div class="widgets-item">
                                            <ul>
                                                <li><a href="javascript:void(0)">Beauty</a></li>
                                                <li><a href="javascript:void(0)">Foot, Hand & Nail Care</a></li>
                                                <li><a href="javascript:void(0)">Fragrance</a></li>
                                                ...
                                                <li><a href="javascript:void(0)">Shave & Hair Removal</a></li>
                                ...
                                <div class="col-lg-3">
                                    <div class="widgets-area filter-item_area">
                                        <h2 class="heading text-capitalize font-style_italic mb-0"><span>Filter By Prices</span></h2>
                                ...
                                <div class="col-lg-3">
                                    <div class="widgets-area filter-item_area">
                                        <h2 class="heading text-capitalize font-style_italic mb-0"><span>Filter by Brands</span></h2>
                                        <ul class="widgets-checkbox">
                                            <li>
                                                <input class="input-checkbox" type="checkbox" id="checkbox-item-1">
                                                <label class="label-checkbox mb-0" for="checkbox-item-1">Forever <sub>21</sub> (4)</label>
                                            </li>
                                            <li>
                                                <input class="input-checkbox" type="checkbox" id="checkbox-item-2">
                                                <label class="label-checkbox mb-0" for="checkbox-item-2">HM (4)</label>
                                            </li>
                                            <li>
                                                <input class="input-checkbox" type="checkbox" id="checkbox-item-3">
                                                <label class="label-checkbox mb-0" for="checkbox-item-3">Lacote (4)</label>
                                            </li>
                                            <li>
                                                <input class="input-checkbox" type="checkbox" id="checkbox-item-4">
                                                <label class="label-checkbox mb-0" for="checkbox-item-4">Mango (4)</label>
                                            </li>
                                            <li>
                                                <input class="input-checkbox" type="checkbox" id="checkbox-item-5">
                                                <label class="label-checkbox mb-0" for="checkbox-item-5">Six8 (4)</label>
                                            </li>
                                            <li>
                                                <input class="input-checkbox" type="checkbox" id="checkbox-item-6">
                                                <label class="label-checkbox mb-0" for="checkbox-item-6">Uniquilo (4)</label>
                                            </li>
                                            <li>
                                                <input class="input-checkbox" type="checkbox" id="checkbox-item-7">
                                                <label class="label-checkbox mb-0" for="checkbox-item-7">Versatile (4)</label>
                                            </li>
                                            <li>
                                                <input class="input-checkbox" type="checkbox" id="checkbox-item-8">
                                                <label class="label-checkbox mb-0" for="checkbox-item-8">Zara (4)</label>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-3">
                                    <div class="widgets-area filter-item_area">
                                        <h2 class="heading text-capitalize font-style_italic mb-0"><span>Popular Tags</span></h2>
                                        <div class="widgets-tags with-border">
                                            <ul>
                                                <li><a href="javascript:void">Beauty</a></li>
                                                <li><a href="javascript:void">Cosmetic</a></li>
                                                <li><a href="javascript:void">Skincare</a></li>
                                                <li><a href="javascript:void">Skin solution</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <?php 
                         $query1 = "SELECT * FROM inventario";
                          $tabla = mysqli_query($data, $query1);
                    ...
                    ?>
                                ...
                                <div class="product-item">
                                    <div class="single-product">      
                                        ...
                                        <div class="product-img">
                                             <a href="single-product.html">
                                                <img class="primary-img" src="data:image/jpg;base64,<?php echo base64_encode($row['Imagen']); ?>" alt="Image Product"/> 
                                            
                                                <img class="secondary-img" src="data:image/jpg;base64,<?php echo base64_encode($row['Imagen']); ?>"s alt="Image Product">
                                            </a>
                                           <!-- <a href="single-product.html">
                                        ...
                                        <div class="product-content">
                                            <div class="product-desc_info">
                                                <h3 class="product-name mb-0">
                                                    <?php echo $row['NombreProd'] ?>
                                                    
                                                </h3>
                                                <div class="price-box">
                                                    <span class="new-price ms-0">$<?php echo $row['PrecioProd'] ?></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="list-product_item">
                                    <div class="single-product">
                                        ...
                                        <div class="product-content">
                                            <div class="product-desc_info">
                                                <h3 class="product-name mb-0"><a href="single-product.html">Adonia 7 Minute Lift Organic</a></h3>
                                                <div class="price-box">
                                                    <span class="new-price">$<?php echo $row['PrecioProd'] ?></span>
                                                </div>
                                                <p class="short-desc mb-0">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
                                            ...
                                            <div class="add-actions-2">
                                                <ul>
                                                    <li class="add-to-cart"><a href="cart.php" data-bs-toggle="tooltip" data-placement="top" title="Add To Cart">Add to cart</a>
                                                    </li>
                                                    <li><a href="wishlist.html" data-bs-toggle="tooltip" data-placement="top" title="Add To Wishlist"><i class="bi bi-suit-heart-fill"></i></a>
                                                    </li>
                                                    <li><a href="compare.html" data-bs-toggle="tooltip" data-placement="top" title="Add To Compare"><i class="lastudioicon-compare"></i></a>
                            ...
                            <div class="col-12">
                                <div class="product-item">
                                    <div class="single-product">
                                        ...
                                        <div class="product-content">
                                            <div class="product-desc_info">
                                                <h3 class="product-name mb-0"><a href="single-product.html">
                                                    <?php echo $row['NombreProd'] ?></a></h3>
                                                <div class="price-box">
                                ...
                                <div class="list-product_item">
                                    <div class="single-product">
                                        ...
                                        <div class="product-content">
                                            <div class="product-desc_info">
                                                <h3 class="product-name mb-0"><a href="single-product.html">BOTANIC HEARTH Biotin Shampoo and Conditioner</a></h3>
                                                <div class="price-box">
                            ...
                            <div class="col-12">
                                <div class="product-item">
                                    <div class="single-product">
                                        ...
                                        <div class="product-content">
                                            <div class="product-desc_info">
                                                <h3 class="product-name mb-0"><a href="single-product.html">Cute Travel Makeup Bag</a></h3>
                                                <div class="price-box">
                                                    <span class="new-price ms-0">$50.00</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-12">
                                <div class="product-item">
                                    <div class="single-product">
                                        ...
                                        <div class="product-content">
                                            <div class="product-desc_info">
                                                <h3 class="product-name mb-0"><a href="single-product.html">Double Chin Reducer│6PCS</a></h3>
                                                <div class="price-box">
                                                    <span class="new-price ms-0">$20.00</span>
                                                </div>
                                            </div>
                            ...
                            <div class="col-12">
                                <div class="product-item">
                                    <div class="single-product">
                                        ...
                                        <div class="product-content">
                                            <div class="product-desc_info">
                                                <h3 class="product-name mb-0"><a href="single-product.html">Eye Cream For Dark Circles</a></h3>
                                                <div class="price-box">
                                                    <span class="new-price ms-0">$20.00</span>
                                                </div>
                                            </div>
                            ...
                            <div class="col-12">
                                <div class="product-item">
                                    <div class="single-product">
                                        ...
                                        <div class="product-content">
                                            <div class="product-desc_info">
                                                <h3 class="product-name mb-0"><a href="single-product.html">Eye Cream Gel – Top Influencer</a></h3>
                                                <div class="price-box">
                                                    <span class="new-price ms-0">$20.00</span>
                                                </div>
                                            </div>
                            ...
                            <div class="col-12">
                                <div class="product-item">
                                    <div class="single-product">
                                        ...
                                        <div class="product-content">
                                            <div class="product-desc_info">
                                                <h3 class="product-name mb-0"><a href="single-product.html">HASK BLUE CHAMOMILE Shampoo and Conditioner</a></h3>
                                                <div class="price-box">
                                                    <span class="new-price ms-0">$20.00</span>
                                                </div>
                                            </div>
                            ...
                            <div class="col-12">
                                <div class="product-item">
                                    <div class="single-product">
                                        <div class="product-img">
                                            <a href="single-product.html">
                                                <img class="primary-img" src="assets/images/product/medium-size/1-2.jpg" alt="Yena's Product Image">
                                                <img class="secondary-img" src="assets/images/product/medium-size/1-1.jpg" alt="Yena's Product Image">
                                            </a>
                                            <div class="add-actions">
                                                <ul>
                                                    <li><a href="cart.php" data-bs-toggle="tooltip" data-placement="top" title="Add To cart"><i class="lastudioicon-shopping-cart-3"></i></a>
                                        ...
                                        <div class="product-content">
                                            <div class="product-desc_info">
                                                <h3 class="product-name mb-0"><a href="single-product.html">InstaBoost Conditioning Color Masque</a></h3>
                                                <div class="price-box">
                                                    <span class="new-price ms-0">$20.00</span>
                                                </div>
                                            </div>
                            ...
                            <div class="col-12">
                                <div class="product-item">
                                    <div class="single-product">
                                        <div class="product-img">
                                            <a href="single-product.html">
                                                <img class="primary-img" src="assets/images/product/medium-size/2-2.jpg" alt="Yena's Product Image">
                                                <img class="secondary-img" src="assets/images/product/medium-size/2-1.jpg" alt="Yena's Product Image">
                                            </a>
                                            <div class="add-actions">
                                                <ul>
                                                    <li><a href="cart.php" data-bs-toggle="tooltip" data-placement="top" title="Add To cart"><i class="lastudioicon-shopping-cart-3"></i></a>
                            ...
                            <div class="col-12">
                                <div class="product-item">
                                    <div class="single-product">
                                        <div class="product-img">
                                            <a href="single-product.html">
                                                <img class="primary-img" src="assets/images/product/medium-size/3-2.jpg" alt="Yena's Product Image">
                                                <img class="secondary-img" src="assets/images/product/medium-size/3-1.jpg" alt="Yena's Product Image">
                                            </a>
                                            <div class="add-actions">
                                                <ul>
                                                    <li><a href="cart.php" data-bs-toggle="tooltip" data-placement="top" title="Add To cart"><i class="lastudioicon-shopping-cart-3"></i></a>
                            ...
                            <div class="col-12">
                                <div class="product-item">
                                    <div class="single-product">
                                        <div class="product-img">
                                            <a href="single-product.html">
                                                <img class="primary-img" src="assets/images/product/medium-size/4-2.jpg" alt="Yena's Product Image">
                                                <img class="secondary-img" src="assets/images/product/medium-size/4-1.jpg" alt="Yena's Product Image">
                                            </a>
                                            <div class="add-actions">
                                                <ul>
                                                    <li><a href="cart.php" data-bs-toggle="tooltip" data-placement="top" title="Add To cart"><i class="lastudioicon-shopping-cart-3"></i></a>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-body">
                        ...
                        <div class="modal-inner-area product-details_area row">
                            <div class="col-xl-5 col-lg-6">
                                <div class="product-details_img">
                                    <div class="product-details_slider slick-img-slider yena-element-carousel" data-slick-options='{
                                    "slidesToShow": 1,
                                    "arrows": false,
                                    "fade": true,
                                    "draggable": false,
                                    ...
                                    "asNavFor": ".pd-slider-nav"
                                        ...
                                        <div class="single-img zoom">
                                            <img src="assets/images/product/large-size/1.jpg" alt="Yena's Product Image">
                                            <span class="sticker">New</span>
                                        </div>
                                        <div class="single-img zoom">
                                            <img src="assets/images/product/large-size/2.jpg" alt="Yena's Product Image">
                                            <span class="sticker">New</span>
                                        </div>
                                        <div class="single-img zoom">
                                            <img src="assets/images/product/large-size/3.jpg" alt="Yena's Product Image">
                                            <span class="sticker">New</span>
                                        </div>
                                        <div class="single-img zoom">
                                            <img src="assets/images/product/large-size/4.jpg" alt="Yena's Product Image">
                                            <span class="sticker">New</span>
                                        </div>
                                    </div>
                                    <div class="pd-slider-nav yena-element-carousel arrow-style arrow-sm_size arrow-day_color" data-slick-options='{
                                    "slidesToShow": 3,
                                    ...
                                    "spaceBetween": 30
                                        ...
                                        <div class="single-thumb">
                                            <img src="assets/images/product/large-size/1.jpg" alt="Yena's Product Thumnail">
                                        </div>
                                        <div class="single-thumb">
                                            <img src="assets/images/product/large-size/2.jpg" alt="Yena's Product Thumnail">
                                        </div>
                                        <div class="single-thumb">
                                            <img src="assets/images/product/large-size/3.jpg" alt="Yena's Product Thumnail">
                                        </div>
                                        <div class="single-thumb">
                                            <img src="assets/images/product/large-size/4.jpg" alt="Yena's Product Thumnail">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-7 col-lg-6">
                                <div class="product-details_content">
                                    <h3 class="heading text-uppercase mb-0">Skin Care Yena 2020</h3>
